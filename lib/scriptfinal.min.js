var isGetUserMediaSupported=!1,isLocalStorageSupported=!1,isGeoLocationSupported=!1,isTouchSupported=!1,isVibrationSupported=!1,isOrientationSupported=!1,isAppCacheSupported=!1,isMeterSupported=!1,isWebRTCSupported=!1,isBatterySupported=!1,isMediaDevicesSupported=!1,GOOGLE_API_KEY="AIzaSyBYE5sFTGdc4L3lp9Qe_N2wxtFRl26UKzQ";window.onload=function(){checkSupportedFeature();configCamera();configLocation();configBattery();getLocalSavedBlogs()};
...
", ")+"Enumerate Devices";if(""!=a){var b=document.getElementById("invalidFeatureLabel"),c=document.getElementById("invalidFeatureDiv");b.textContent=a+" are not supported in this browser or device.";c.style.display="block"}}var width=320,height=0,size=0,direction=0,isStreaming=!1,video=null,canvas=null,photo=null,photobutton=null,photobutton2=null,addBlog=null,textArea=null,imageData=null,previewDiv=null;
...
function configLocation(){locationInput=document.getElementById("locationInput");var a=document.getElementById("locationSwitch");showLocationInput(a.checked);a.addEventListener("change",function(){this.checked?!0===isGeoLocationSupported?(a.disabled=!0,showLocationInput(!0),locationInput.placeholder="Loading Location...",navigator.geolocation.getCurrentPosition(function(b){a.disabled=!1;showLocationInfo(b.coords.latitude,b.coords.longitude);locationInput.placeholder="Input Location"},function(b){a.disabled=
!1;var c={0:"Unknown error",1:"Permission denied by user",2:"Position is not available",3:"Request timed out"}[b.code];if(0==b.code||2==b.code)c+=": "+b.message;showLocationInput(!0,c);locationInput.placeholder="Input Location"})):showLocationInput(!0,"Geolocation function is not supported"):showLocationInput(!1)})}
...
a.formatted_address&&""!=a.formatted_address?locationInput.value=a.formatted_address:document.getElementById("locationSupportInfo").textContent="Cannot get address information")}};c.open("GET","https://maps.googleapis.com/maps/api/geocode/json?latlng="+a+","+b+"&key=AIzaSyBYE5sFTGdc4L3lp9Qe_N2wxtFRl26UKzQ",!0);c.send()},batteryLevel=-1;
